...
function EditVehicleManufacturer() {
  ...
  return (
    <>
      <div>{data && data.brand_name}</div>
      <h1 className="text-2xl mb-5">Editng Vehicle Manufacturer with ID: {id}</h1>
      <form >
        <div className="mb-5">
          <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-2xl p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" placeholder="Brand Name"></input>
        </div>
        <div className="mb-5">
